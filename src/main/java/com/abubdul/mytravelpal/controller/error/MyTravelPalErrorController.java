 ...
 *
 */
public class MyTravelPalErrorController extends BasicErrorController {

	/**
	 * @param errorAttributes
	 * @param errorProperties
	 */
	public MyTravelPalErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
